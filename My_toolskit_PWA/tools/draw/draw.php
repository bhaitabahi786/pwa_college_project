...
<head>
  ...
  <!-- styles import -->
  <link rel="stylesheet" href="../../tools/draw/draw.css">
...
<body>
 ...
 <div class="white container">
  ...
  font-family: 'Oswald', sans-serif;font-size:30px;">Draw
...
<!-- draw btns and tools sliders, colors-->
<div class="col s12 m3 center-on-small-only">
  <div class="card-panel grey lighten-3">
    <div class="row">
      <div class="col s12 m2">
        <div class="range-field">
          <input type="range" id="vol" min="1" max="30" value="7"/>
        </div>
        <div onclick="colorChange('#b9b9b9')" class="waves-light waves-effect btn deep-purple darken-3">
          <i class="material-icons white-text">call_to_action</i>
        </div>
        <div id="undo" class="waves-light waves-effect btn deep-purple darken-3">
          <i class="material-icons white-text">undo</i>
        </div>
        <div id="clear" class="waves-light waves-effect btn deep-purple darken-3">
          <i class="material-icons white-text">delete</i>
        </div>
        <div id="save" class="waves-light waves-effect btn deep-purple darken-3">
          <i class="material-icons white-text">file_download</i>
        </div>
        <!-- colors in btns -->
        <br><p class="teal-text"><b>Colors</b></p>
        <div onclick="colorChange('white')" style="background: white" class="waves-light waves-effect btn white darken-4"></div>
        <div onclick="colorChange('black')" style="background: black" class="waves-light waves-effect btn black darken-4"></div>
        <div onclick="colorChange('#ff4757')" style="background: #ff4757" class="waves-light waves-effect btn red darken-3"></div>
        <div onclick="colorChange('#0be881') " style="background: #0be881" class="waves-light waves-effect btn green darken-3"></div>
        <div onclick="colorChange('#1e90ff')" style="background: #1e90ff" class="waves-light waves-effect btn light-blue darken-3"></div>
        <div onclick="colorChange('#ffdd59')" style="background: #ffdd59" class="waves-light waves-effect btn yellow darken-3"></div>
        <div onclick="colorChange('#7d5fff')" style="background: #7d5fff" class="waves-light waves-effect btn purple darken-3"></div>
        <div onclick="colorChange('#fd9644')" style="background: #fd9644" class="waves-light waves-effect btn orange darken-3"></div>
        <div onclick="colorChange('#5f5348')" style="background: #5f5348" class="waves-light waves-effect btn brown darken-3"></div>
      </div>

      <!-- drawing canvas  -->
      <div class="col s12 m10">
        <canvas id="canvas" class="center-on-small-only"></canvas>
      </div>
    </div>
  </div>
</div>
...
<div id="helptracker" class="modal">
  <div class="modal-content">
    <div class="white container">
      <h5>💡 Tip</h5>
      <blockquote>
        You can Draw in the grey area field 
        all the necessary  tools are provided in the left hand side on the large screen devices 
        or upper side on Mobile screen<u> there is pen slider for size adjusting of the pen pixel</u>
        <ol>
          <li>
            <i class="material-icons">call_to_action</i>eraser
          </li>
          <li>
        ...
        also there are 9 colors that you can freely choose as you required , after compelting the drawing you
        can download via  <i class="material-icons">file_download</i> botton
      </blockquote>
...
<section class="infomodal">
  ...
  <script src="../../tools/draw/draw.js"></script>
